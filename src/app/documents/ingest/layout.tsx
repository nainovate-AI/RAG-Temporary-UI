...
const steps = [
  ...
  },
  {
    ...
    icon: Settings,
    path: '/documents/ingest/new/processing',
  },
  {
    id: 'embedding',
    title: 'Embedding',
    ...
    icon: Brain,
    path: '/documents/ingest/new/embedding',
  },
  {
    id: 'vectorstore',
    title: 'Vector Store',
    ...
    icon: Database,
    path: '/documents/ingest/new/vector-store',
  },
  {
    id: 'review',
    title: 'Review & Start',
    ...
    icon: CheckCircle,
    path: '/documents/ingest/new/review',
  },
]
