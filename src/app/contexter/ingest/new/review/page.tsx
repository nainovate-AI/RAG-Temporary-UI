...
const steps = [
  { id: 'collection', title: 'Collection Info', icon: Folder, path: '/contexter/ingest/new' },
  { id: 'processing', title: 'Processing', icon: Settings, path: '/contexter/ingest/new/processing' },
  { id: 'embedding', title: 'Embedding', icon: Brain, path: '/contexter/ingest/new/embedding' },
  { id: 'vectorstore', title: 'Vector Store', icon: Database, path: '/contexter/ingest/new/vector-store' },
]
